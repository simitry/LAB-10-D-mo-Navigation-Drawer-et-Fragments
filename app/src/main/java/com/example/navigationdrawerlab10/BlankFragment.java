...
public class BlankFragment extends Fragment { // This class represents Fragment 1.
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) { // This method creates the fragment screen.
        return inflater.inflate(R.layout.fragment_blank, container, false); // This line loads the XML layout for Fragment 1.
    }
}
